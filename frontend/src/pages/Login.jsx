      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        <p> Please {state === 'Sign Up' ? "sign up" : "log in"} to book appointment</p>
        {
          ...
          <div className='w-full'>
            <p>Full Name</p>
            {/* whenever we'll update the i/p field, the state will be updated & stored */}
        ...
        <div className='w-full'>
          <p>Password</p>
          {/* whenever we'll update the i/p field, the state will be updated & stored */}
          <input className='border border-zinc-300 rounded w-full p-2 mt-1' type="password" onChange={(e)=>setName(e.target.name)} value={name}/>
        </div>
